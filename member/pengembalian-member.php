   ...
   ?>
                    <tr>
                        ...
                        <td class="text-center">
                            <a href="hapus-peminjaman-member.php?id=<?= $d['id_peminjaman']; ?>" class="fa fa-xl fa-trash color-red p-2 text-white rounded" data-toggle="tooltip" title="Kembalikan"></a>
                        </td>
