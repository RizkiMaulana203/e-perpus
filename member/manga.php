...
$inventaris = query("SELECT * FROM inventaris WHERE id_jenis = 2");
...
if(isset($_POST['submit'])) {
 ...
 if( pinjam($_POST) > 0 ) {
       ...
       document.location.href = 'peminjaman-member.php'
        </script>";
        echo "cek";

    } else {
        echo "<div class='alert alert-warning'>buku gagal dipinjam</div>";
    }
}
             ...
             <div>
              ...
              <div>
                ...
                <div class="mt-5">
                  ...
                  <a href="peminjaman-member.php" class="btn btn-success"><span class="fa fa-arrow-circle-left"></span> Kembali</a>
                </div>
